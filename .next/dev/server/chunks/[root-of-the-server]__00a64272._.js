...
"[project]/src/app/api/v1/auth/recover/password/request/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const RequestSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    identifier: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1).max(254)
});
async function POST(req) {
    ...
    if (!rl.allowed) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(429, "RATE_LIMITED", "Too many reset requests. Wait a minute.", requestId);
    }
    let body;
    try {
        body = await req.json();
    ...
    if (!parsed.success) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(422, "VALIDATION_ERROR", "Enter your username, email or phone number.", requestId);
    }
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$recovery$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requestPasswordReset"])(parsed.data, requestId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00a64272._.js.map