...
"[project]/src/app/api/v1/auth/phone/verify/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const VerifySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    otp: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().regex(/^\d{6}$/)
});
async function POST(req) {
    ...
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clientKey"])(req, "phone-verify"), 10, 60_000);
    if (!rl.allowed) {
    ...
    if (!parsed.success) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(422, "VALIDATION_ERROR", "Enter the 6-digit code.", requestId);
    }
    const verified = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$phone$2d$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyPhoneOtp"])(parsed.data, requestId);
    if (!verified.ok) {
        ...
        const message = verified.code === "MAX_ATTEMPTS" ? "Too many incorrect codes. Request a new one." : "That code is invalid or expired. Request a new one.";
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(401, "OTP_INVALID", message, requestId);
    }
    if (verified.purpose === "LOGIN" || verified.purpose === "RECOVERY") {
        const login = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$phone$2d$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["completePhoneLogin"])({
            sessionId: parsed.data.sessionId
        }, requestId);
        if (!login.ok) {
            // Unknown number / inactive account — same generic error as a bad code.
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(401, "OTP_INVALID", "That code is invalid or expired. Request a new one.", requestId);
        }
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$account$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserById"])(login.userId);
        if (!user) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(401, "OTP_INVALID", "That code is invalid or expired. Request a new one.", requestId);
        }
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$phone$2d$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyPhoneSignIn"])(user.id, ua);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aca22267._.js.map