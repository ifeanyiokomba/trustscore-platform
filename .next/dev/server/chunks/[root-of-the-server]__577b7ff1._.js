...
"[project]/src/app/api/v1/dev/keys/[id]/revoke/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    ...
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])(`dev-revoke:${user.id}`, 10, 60_000);
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$devportal$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revokeApiKey"])(user.id, id);
    if (!result.ok) {
        switch(result.code){
            case "NOT_FOUND":
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(404, "NOT_FOUND", "No such API key.", requestId);
            case "FORBIDDEN":
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(403, "FORBIDDEN", "Your team role does not allow revoking keys.", requestId);
            case "ALREADY_REVOKED":
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(409, "ALREADY_REVOKED", "This key is already revoked.", requestId);
        }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__577b7ff1._.js.map