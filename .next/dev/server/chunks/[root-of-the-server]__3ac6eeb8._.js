...
"[project]/src/app/api/v1/identity/sessions/[id]/consent/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const ConsentSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
async function POST(req, { params }) {
    ...
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clientKey"])(req, "identity-consent"), 12, 60_000);
    if (!rl.allowed) {
    ...
    if (!parsed.success) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(422, "VALIDATION_ERROR", "decision must be GRANT or DENY.", requestId);
    }
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$identity$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyConsentDecision"])(user.id, id, parsed.data.decision, requestId, parsed.data.scopes);
    if (!result.ok) {
        switch(result.code){
            ...
            case "NOT_PENDING":
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(409, "NOT_PENDING", "This session is not awaiting a consent decision.", requestId);
            case "EXPIRED":
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(410, "EXPIRED", "This verification session has expired. Start a new one.", requestId);
            case "DENIED":
            ...
            case "SCOPE_INVALID":
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(422, "SCOPE_INVALID", "Granted scopes must be a subset of the requested scopes and include the core verification scopes.", requestId);
            case "PROVIDER_UNAVAILABLE":
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(503, "PROVIDER_UNAVAILABLE", "The NINAuth provider is temporarily unavailable (transport failure). Your consent decision was not recorded — try again shortly.", requestId);
        }
    }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])({
        ok: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ac6eeb8._.js.map