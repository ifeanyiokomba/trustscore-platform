...
"[project]/src/app/api/v1/dev/clients/[id]/decisions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$devportal$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDecisions"])(user.id, id, 50);
        if (!result.ok) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(result.code === "NOT_FOUND" ? 404 : 403, result.code, "No access to this API client.", requestId);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__947d68ac._.js.map