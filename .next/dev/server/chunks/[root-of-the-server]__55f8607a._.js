...
"[project]/src/app/api/v1/passport/share/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(req, { params }) {
    ...
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clientKey"])(req, "share-revoke"), 10, 60_000);
    if (!rl.allowed) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(429, "RATE_LIMITED", "Too many revocations. Wait a minute.", requestId);
    }
    const { id } = await params;
    const outcome = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$passport$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revokeShareToken"])(user.id, id);
    if (outcome === "NOT_FOUND") {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(404, "NOT_FOUND", "Trust link not found.", requestId);
    }
    if (outcome === "ALREADY") {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(409, "ALREADY_REVOKED", "This trust link is already revoked.", requestId);
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__55f8607a._.js.map