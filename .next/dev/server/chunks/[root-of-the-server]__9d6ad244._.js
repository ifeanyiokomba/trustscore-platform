...
"[project]/src/app/api/v1/auth/google/[id]/grant/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const GrantSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().toLowerCase().email().max(254)
});
async function POST(req, { params }) {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$providers$2f$google$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["GOOGLE_MODE"] === "LIVE") {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(404, "NOT_FOUND", "Not found.", requestId);
    }
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$google$2d$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyGoogleGrant"])({
        sessionId: id,
    ...
    if (!result.ok) {
        const map = {
            ...
            NOT_PENDING: {
                status: 409,
                message: "This sign-in was already decided."
            },
            EXPIRED: {
                status: 410,
            ...
            DENIED: {
                status: 403,
                message: "You denied the Google sign-in."
            },
            EMAIL_INVALID: {
                status: 422,
                message: "Enter a valid Google email."
            }
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d6ad244._.js.map