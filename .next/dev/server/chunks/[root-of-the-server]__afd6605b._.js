...
"[project]/src/app/api/v1/auth/google/[id]/callback/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CallbackSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(16).max(128),
    state: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(8).max(128)
});
async function POST(req, { params }) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$google$2d$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["completeGoogleLogin"])({
        sessionId: id,
    ...
    if (!result.ok) {
        if (result.code === "LINK_REQUIRED") {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])({
                ...
                message: "An account exists with this email. Sign in with your password to link Google to it.",
                requestId
            }, 200);
        }
        const map = {
            SESSION_NOT_FOUND: {
                status: 404,
                message: "Unknown Google sign-in session."
            },
            BAD_STATE: {
                status: 400,
                message: "State mismatch — the sign-in session was invalidated. Start again."
            },
            NOT_GRANTED: {
                status: 409,
                message: "This sign-in has not been granted yet."
            },
            CODE_REUSED: {
                status: 409,
                message: "This sign-in code was already used."
            },
            EXCHANGE_FAILED: {
                status: 400,
                message: "The code exchange failed. Start again."
            },
            TOKEN_INVALID: {
                status: 401,
                message: "The Google identity assertion failed validation."
            }
        };
    ...
    if (!user) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(401, "INVALID_CREDENTIALS", "Sign-in failed. Please try again.", requestId);
    }
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$google$2d$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyGoogleSignIn"])(user.id, ua);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__afd6605b._.js.map