...
"[project]/src/app/api/v1/dev/clients/[id]/webhook/test/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    ...
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])(`dev-webhook-test:${user.id}:${id}`, 6, 60_000);
    if (!rl.allowed) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(429, "RATE_LIMITED", "Too many test sends. Wait a minute.", requestId);
    }
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$devportal$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireRole"])(user.id, id, "DEVELOPER");
    } catch (e) {
    ...
    if (!client.webhookUrl || !client.webhookSecret) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(422, "WEBHOOK_NOT_CONFIGURED", "Configure a webhook URL first — the test event is delivered to your configured endpoint.", requestId);
    }
    const { deliveryId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$webhook$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enqueueDelivery"])(client, "WEBHOOK_TEST", {
    ...
    const row = deliveryId ? await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].webhookDelivery.findUnique({
        where: {
            id: deliveryId
        }
    }) : null;
    if (!row) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(500, "DELIVERY_FAILED", "The test delivery could not be recorded.", requestId);
    }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])({
        delivery: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$webhook$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shapeDelivery"])(row),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__77970ef6._.js.map