...
"[project]/src/app/api/v1/passport/dsr/[id]/export/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$passport$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDsrExportPayload"])(user.id, id);
    if (!result) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(404, "NOT_FOUND", "Export not found.", requestId);
    }
    if (result.expired) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(410, "EXPIRED", "This export passed its 7-day retention window.", requestId);
    }
    const filename = `trustscore-export-${new Date().toISOString().slice(0, 10)}.json`;
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](result.payload, {
        status: 200,
        headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a9bde43._.js.map