...
"[project]/src/app/api/v1/auth/email/verify/request/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$recovery$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requestEmailVerification"])(user.id, requestId);
    if (!result.ok) {
        const map = {
            NO_EMAIL: {
                status: 409,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb54376c._.js.map