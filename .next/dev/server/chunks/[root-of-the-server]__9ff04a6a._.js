...
"[project]/src/app/api/v1/businesses/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CreateSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    rcNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(3).max(20)
});
async function POST(req) {
    ...
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clientKey"])(req, "business-create"), 10, 60_000);
    if (!rl.allowed) {
    ...
    if (!parsed.success) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(422, "VALIDATION_ERROR", "name and rcNumber are required.", requestId);
    }
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$business$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createBusinessProfile"])(user.id, parsed.data, requestId);
    if (!result.ok) {
        switch(result.code){
            case "RC_MALFORMED":
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(422, "RC_MALFORMED", "That doesn't look like a CAC registration number. Use the registry prefix (RC, BN or IT) followed by 3–10 characters, e.g. RC 1234567.", requestId);
            case "NAME_INVALID":
            ...
            case "LIMIT_REACHED":
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(409, "LIMIT_REACHED", `You already have the maximum of 5 business profiles. Remove one to add another.`, requestId);
            case "DUPLICATE":
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(409, "DUPLICATE", "You have already claimed this registration number.", requestId);
        }
    }
...
async function GET(req) {
    ...
    const profiles = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$business$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listBusinessProfiles"])(user.id);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])({
        profiles,
        requestId
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9ff04a6a._.js.map