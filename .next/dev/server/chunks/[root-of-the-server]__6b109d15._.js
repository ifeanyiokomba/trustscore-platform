...
"[project]/src/app/api/v1/dev/clients/[id]/team/[memberId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(req, { params }) {
    ...
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$devportal$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["removeTeamMember"])(user.id, id, memberId);
        if (!result.ok) {
            switch(result.code){
                case "NOT_FOUND":
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(404, "NOT_FOUND", "No such team member on this client.", requestId);
                case "FORBIDDEN":
                ...
                case "OWNER_IMMUTABLE":
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(409, "OWNER_IMMUTABLE", "The OWNER membership cannot be removed.", requestId);
            }
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b109d15._.js.map