...
"[project]/src/app/api/v1/admin/security-posture/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (user.role !== "ADMIN") {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonError"])(403, "FORBIDDEN", "Security posture is restricted to platform admins.", requestId);
    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$boot$2d$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertSecretsAtBoot"])();
    const secrets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$boot$2d$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["secretPosture"])();
    const production = ("TURBOPACK compile-time value", "development") === "production";
    const forceNonce = process.env.TS_FORCE_NONCE_CSP === "1";
    const cspMode = production || forceNonce ? "nonce" : "dev-compat (unsafe-inline scripts allowed; HMR requirement)";
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonOk"])({
        ...
        vaultUsesDefaultKey: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$providers$2f$credential$2d$vault$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["vaultUsesDefaultKey"],
        providers: {
            ninauth: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$providers$2f$ninauth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NINAUTH_MODE"],
            phone: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$providers$2f$phone$2d$provider$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PHONE_MODE"],
            liveness: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$providers$2f$liveness$2d$provider$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LIVENESS_MODE"],
            google: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$providers$2f$google$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["GOOGLE_MODE"]
        },
        csp: {
            mode: cspMode,
            scriptSrc: production || forceNonce ? "'self' 'nonce-<per-request>' 'strict-dynamic'" : "'self' 'unsafe-inline' ('unsafe-eval' in dev)",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8bfd5997._.js.map