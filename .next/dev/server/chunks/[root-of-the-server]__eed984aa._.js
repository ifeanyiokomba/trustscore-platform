...
"[project]/src/app/api/v1/auth/email/verify/confirm/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ConfirmSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().regex(/^\d{6}$/, "Enter the 6-digit code.")
});
async function POST(req) {
    ...
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clientKey"])(req, "email-verify-confirm"), 10, 60_000);
    if (!rl.allowed) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$recovery$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["confirmEmailVerification"])(user.id, parsed.data, requestId);
    if (!result.ok) {
        const map = {
            NO_PENDING: {
                status: 409,
            ...
            CODE_INVALID: {
                status: 401,
                message: "That code is invalid. Check it and try again."
            },
            MAX_ATTEMPTS: {
                status: 429,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eed984aa._.js.map