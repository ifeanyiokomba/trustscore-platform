(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__bce27db9._.js",
...
"[project]/src/lib/platform/boot-guard.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// TrustScore sec-batch-A — request middleware: boot-guard + CSP.
//
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$boot$2d$guard$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/platform/boot-guard.ts [middleware-edge] (ecmascript)");
;
;
// Fail-closed boot check — before the first byte of any request.
(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$platform$2f$boot$2d$guard$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["assertSecretsAtBoot"])();
function freshNonce() {
...
function middleware(request) {
    ...
    const scriptSrc = useNonce ? `script-src 'self' 'nonce-${nonce}'${("TURBOPACK compile-time truthy", 1) ? " 'unsafe-eval'" : "TURBOPACK unreachable"}` : `script-src 'self' 'unsafe-inline'${("TURBOPACK compile-time truthy", 1) ? " 'unsafe-eval'" : "TURBOPACK unreachable"}`;
    const csp = [
        "default-src 'self'",
        scriptSrc,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bce27db9._.js.map