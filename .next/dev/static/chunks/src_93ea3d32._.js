...
"[project]/src/components/layout/console-guard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ConsoleGuard() {
    _s();
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "ConsoleGuard.useEffect": ()=>{
            const w = window;
            if (!w.__consoleErrors) w.__consoleErrors = [];
            const originalError = console.error.bind(console);
            console.error = ({
                "ConsoleGuard.useEffect": (...args)=>{
                    try {
                        w.__consoleErrors.push(args.map({
                            "ConsoleGuard.useEffect": (a)=>String(a)
                        }["ConsoleGuard.useEffect"]).join(" ").slice(0, 300));
                    } catch  {
            ...
            const onError = {
                "ConsoleGuard.useEffect.onError": (e)=>{
                    try {
            ...
            }["ConsoleGuard.useEffect.onError"];
...
_s(ConsoleGuard, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = ConsoleGuard;
var _c;
__turbopack_context__.k.register(_c, "ConsoleGuard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_93ea3d32._.js.map